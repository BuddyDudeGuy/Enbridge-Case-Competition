...
DATA_DIR = "D:/Personal Projects/Enbridge Case Compettion/data/raw/CARE_To_Compare/Wind Farm A/datasets"
OUTPUT_PATH = "D:/Personal Projects/Enbridge Case Compettion/outputs/reports/farm_a_validation.json"
...
for filepath in csv_files:
    ...
    # Check column count
    if n_cols != 86:
        file_issues.append(f"Expected 86 columns, got {n_cols}")
        file_valid = False
...
if issues:
    ...
    summary = f"All {len(csv_files)} files passed validation. 86 columns each, valid status_type_id and train_test values."
...
# Print summary
print(f"\n{'='*60}")
print(f"FARM A VALIDATION RESULTS")
print(f"{'='*60}")
